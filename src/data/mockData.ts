import type { Cylinder, RepairTask, OperationLog, BorrowRecord, ReservationRecord } from '../types';
...
export const mockReservations: ReservationRecord[] = [
  {
    ...
    reminderStatus: '未提醒',
    adjustReason: '',
    borrowPurpose: '音乐史研究参考',
    applicant: '王研究员',
    approver: '李馆长',
    approvedAt: '2024-05-28 10:30:00',
  ...
  },
  {
    ...
    reminderStatus: '未提醒',
    adjustReason: '',
    borrowPurpose: '儿童节主题活动展示',
    applicant: '社教部李老师',
    approver: '王副馆长',
    approvedAt: '2024-05-30 14:00:00',
  ...
  },
  {
    ...
    status: '待审批',
    conflictStatus: '有冲突',
    conflictReservationIds: ['RES-005'],
    reminderStatus: '未提醒',
    adjustReason: '',
    borrowPurpose: '紧急学术项目参考',
    applicant: '赵教授',
    approver: null,
    approvedAt: null,
    createdAt: '2024-06-03 16:45:00',
    relatedBorrowId: null,
    remark: '项目结题急需',
  },
  {
    id: 'RES-005',
    reservationNo: 'YY-2024-005',
    cylinderId: 'CYL-012',
    cylinderTitle: '男声独唱艺术歌曲',
    borrowType: '馆内借阅',
    priority: '普通',
    ...
    status: '已批准',
    conflictStatus: '有冲突',
    conflictReservationIds: ['RES-004'],
    reminderStatus: '已提醒',
    adjustReason: '',
    borrowPurpose: '常规研究参考',
    applicant: '陈研究员',
    approver: '赵主任',
    approvedAt: '2024-06-01 11:00:00',
  ...
  {
    id: 'RES-006',
    reservationNo: 'YY-2024-006',
    cylinderId: 'CYL-010',
    cylinderTitle: '古典吉他演奏',
    borrowType: '外部借展',
    priority: '优先',
    ...
    reminderStatus: '无需提醒',
    adjustReason: '',
    borrowPurpose: '省美术馆跨界艺术展',
    applicant: '展览部张主任',
    approver: '李馆长',
    approvedAt: '2024-06-02 15:30:00',
  ...
  {
    id: 'RES-007',
    reservationNo: 'YY-2024-007',
    cylinderId: 'CYL-002',
    cylinderTitle: '莫扎特钢琴协奏曲',
    borrowType: '馆内借阅',
    priority: '普通',
    ...
    conflictReservationIds: [],
    reminderStatus: '未提醒',
    adjustReason: '原预约时间与转录工作冲突，已调整至转录完成后',
    borrowPurpose: '作曲技法分析研究',
    applicant: '王研究员',
    approver: '王副馆长',
    approvedAt: '2024-05-29 09:30:00',
    createdAt: '2024-05-27 14:00:00',
    relatedBorrowId: null,
    remark: '',
  },
  {
    id: 'RES-008',
    reservationNo: 'YY-2024-008',
    cylinderId: 'CYL-001',
    cylinderTitle: '贝多芬第五交响曲',
    borrowType: '馆内借阅',
    priority: '普通',
    ...
    reminderStatus: '已提醒',
    adjustReason: '',
    borrowPurpose: '已完成的历史预约',
    applicant: '赵教授',
    approver: '李馆长',
    approvedAt: '2024-05-05 10:00:00',
    createdAt: '2024-05-02 09:00:00',
    relatedBorrowId: null,
    remark: '预约周期已结束',
  },
];
